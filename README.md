...
| --- | --- | --- |
| [`codesweep`](https://github.com/mkasaii16/codesweep-releases) | Finds structurally similar code and maps React, Flutter, Compose, and SwiftUI component trees. | macOS Apple Silicon, macOS Intel, Linux x86-64 |
